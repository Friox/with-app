...
import 'package:app/screens/diary/diary_write.dart';
    ...
    return DefaultTabController(
      ...
      child: NestedScrollView(
          ...
          body: TabBarView(
            ...
            children: [
              CustomScrollView(key: PageStorageKey<String>('tab1'), slivers: [
                SliverPadding(
                  padding: EdgeInsets.only(
                      bottom: LayoutConstants.headerPaddingVertical),
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                        (context, index) => DiaryListItem(
                            data: Diary(
                                date: DateTime.now()
              ...
              CustomScrollView(key: PageStorageKey<String>('tab2'), slivers: [
                SliverPadding(
                  padding: EdgeInsets.only(
                      bottom: LayoutConstants.headerPaddingVertical),
                  sliver: SliverList(
